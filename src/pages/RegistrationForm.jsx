...
const COMMITTEE_COUNTRIES = {
  ...
  'UN General Assembly (UNGA)': [
    ...
    'India', 'Japan', 'Germany', 'Brazil', 'Italy', 'Pakistan', 'South Korea', 'Argentina',
    'Mexico', 'Nigeria', 'South Africa', 'Egypt', 'Kenya', 'Indonesia', 'Turkey',
    'Saudi Arabia', 'Australia', 'Canada', 'Spain', 'Netherlands', 'Sweden', 'Poland',
    'Ukraine', 'Malta', 'Norway', 'Denmark', 'Finland', 'Switzerland', 'Belgium',
    'Austria', 'Portugal', 'Greece', 'Ireland', 'New Zealand', 'Singapore', 'Malaysia',
    'Thailand', 'Vietnam', 'Philippines', 'Bangladesh', 'Sri Lanka', 'Nepal', 'Iran',
    'Iraq', 'Israel', 'United Arab Emirates', 'Qatar', 'Kuwait', 'Jordan', 'Morocco',
    'Algeria', 'Ghana', 'Ethiopia', 'Colombia', 'Chile'
  ],
  'UN Security Council (UNSC) (Double delegation)': [
    'United States of America', 'United Kingdom', 'France', 'Russian Federation', 'China',
  ...
  'International Labour Organization (ILO)': [
    ...
    'Brazil', 'South Africa', 'Sweden', 'Denmark', 'Singapore', 'South Korea', 'Bangladesh',
    'Vietnam', 'Philippines', 'Nigeria', 'Kenya', 'Mexico', 'Argentina', 'Canada', 'Australia',
    'Netherlands', 'Italy', 'Indonesia', 'Ethiopia', 'Spain', 'Poland', 'Egypt', 'Malaysia'
  ],
  'Social, Humanitarian and Cultural Committee (SOCHUM)': [
  ...
  'United States Senate (US SENATE)': [
    ...
    'Angela Alsobrooks (Democrat, Maryland)',
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <span className="text-[11px] text-[#BABABA] block mt-1">
                      📅 Early Bird: <strong className="text-white">₹750</strong> (till Aug 14) | Standard: <strong className="text-white">₹800</strong> (Aug 15–25) | Closure: <strong className="text-red-400">Aug 25, 11:59 PM IST</strong>
                    </span>
                  </div>
                </div>
